  ...
  return (
    <footer className=' py-10 bg-primary  sm:pt-16 lg:pt-24  '  >
      ...
      <div className="container">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-8 gap-y-16 gap-x-12">
          ...
          <div className=' lg:col-span-2'>
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <Link href={routes.stores} className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Cửa hàng </Link>
              </li>

              <li>
                <Link href={routes.artice} className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Tin tức </Link>
              </li>
              ...
              {/* <li>
                <Link href="#"  className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Career </Link>
              </li> */}
            </ul>
          </div>
          ...
          <div className=' lg:col-span-2'>
            ...
            <ul className="mt-6 space-y-4">
              ...
              <li>
                <Link href={routes.guaranteePolicy} className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Chính sách bảo hành </Link>
              </li>
              <li>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form action="#" method="POST" className="mt-6">
              <div className=' mb-4'>
                ...
                <input type="email" name="email" id="email" placeholder="Nhập email của bạn" className="block w-full p-4 text-white placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
              </div>
        ...
        <p className="text-sm text-center text-white">© Copyright 2024, All Rights Reserved by TP MOBILE</p>
      </div>
