    ...
    return (
        <div className=' container mt-[-140px] p-10 pb-20 z-10 relative bg-white rounded-t-[40px] shadow-md'>
            <div className="content-pag  ">
                <h3 className={` p-2  text-center  text-3xl  font-semibold  relative before:content-[''] before:absolute before:bottom-0 before:left-1/2 before:-translate-x-1/2 before:w-16 before:h-0.5 before:bg-primary before:rounded-md`}>ƯU ĐÃI ĐẶC BIỆT DÀNH CHO KHÁCH HÀNG TẠI TP MOBILE </h3>
                <p className=' m-2 text-center  text-[#EF6837]'>Mua sắm tại TP Mobile, nhận ngay bộ quà tặng hấp dẫn với tổng giá trị lên đến 4.000.000 VNĐ!</p>
