...
export default function page() {
    ...
    const datas = [
        ...
        {
            label: `Gọi đặt mua ${CONFIG.HOTLINE}`,
    ...
    return (
        <div className=' container px-0'>
            ...
            <div className="flex min-h-dvh  w-full flex-col overflow-x-hidden @container/profile-container relative">
                ...
                />
                <div className="flex h-full w-full flex-1 flex-col justify-between px-4 pb-8    pt-36 sm:pb-16">
                    <div className="mx-auto h-full w-full max-w-profileContainer">
                        <div className="flex flex-col items-center">
                            <div className="h-[10rem] sm:h-[16rem]" id="profile-picture">
                                <div
                                    style={{
                                        ...
                                        backgroundImage:
                                            "url(https://cdn.tpmobile.com.vn/image/upload/v1745584673/tpmobile-images-public/avt.webp)",
                                        mask:
                            ...
                            <div className="mx-3 flex max-w-full items-center" id="profile-title">
                                <h1 className="mb-4 text-white text-ellipsis text-balance text-center text-lg font-[700] leading-[1.5] text-bodyText">
                        ...
                        >
                            {datas.map(data => {
                                return (
                                    <div className="h-full" key={data.label}>
                                        <div className="relative h-full" data-id={"109874977"}>
                                            ...
                                            <div
                                                ...
                                                className="sc-bdfBwQ  sc-bkzZxe iptHnH hHvFJ group  block"
                                            >
                                                <div className=' text-gray-600 absolute left-3 top-0 bottom-0 flex items-center justify-center'>
                                                    {data.icon}
                                                </div>
                                                <a
                                                    href={data.url}
